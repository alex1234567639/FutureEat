...
export default {
  ...
  data() {
    return {
      ...
      inputNote: '',
      menu: [
        { id: 0, name: '蒜泥低脂豬肉片', price: 100, amount: 0 },
        { id: 1, name: '香蒜水煮雞胸', price: 105, amount: 0 },
        { id: 2, name: '義式香草雞腿排', price: 125, amount: 0 },
        { id: 3, name: '鹽烤鯖魚', price: 120, amount: 0 },
        { id: 4, name: '義式櫛瓜杏苞姑', price: 110, amount: 0 },
        { id: 5, name: '味噌烤豬里肌', price: 120, amount: 0 },
        { id: 6, name: '墨西哥火烤雞胸', price: 110, amount: 0 },
        { id: 7, name: '十三香滷牛腱', price: 130, amount: 0 },
